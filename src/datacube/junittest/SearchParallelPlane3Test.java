 ...
 * Create {@link JUnit4} test case for {@link SearchParallelPlane3} class</br>
 * 
 * @author btdiem </br>
 *
 */
public class SearchParallelPlane3Test extends AbstractSearch3DTest {
	...
	public AbstractSearch3D getDefaultConstructor() throws InvariantBroken {
		return new SearchParallelPlane3(threeD, word_ParallelPlane3);
	}
	...
	public AbstractSearch3D getContructor_SearchNotFound()
		...
		return new SearchParallelPlane3(threeD, word_search_NotFound);
	}
	...
	public void testConstructor_ArrayNULL() throws InvariantBroken {
		new SearchParallelPlane3(null, word_search_NotFound);
	...
	public void testConstructor_WordNULL() throws InvariantBroken {
		new SearchParallelPlane3(threeD, null);
	...
	public void testConstructor_NOK() throws InvariantBroken {
		new SearchParallelPlane3(null, null);
	...
	public AbstractSearch3D getContructor_SearchNotOK() throws InvariantBroken {
		return new SearchParallelPlane3(threeD, word_search_overlen);
	}
