 ...
 * Create {@link JUnit4} test cases for {@link SearchParallelPlane1} </br>
 * @author btdiem </br>
 *
 */
public class SearchParallelPlane1Test extends AbstractSearch3DTest {
	...
	public AbstractSearch3D getDefaultConstructor() throws InvariantBroken {
		return new SearchParallelPlane1(threeD, word_ParallelPlane1);
	}
	...
	public AbstractSearch3D getContructor_SearchNotFound()
		...
		return new SearchParallelPlane1(threeD, word_search_NotFound);
	}
	...
	public void testConstructor_ArrayNULL() throws InvariantBroken {
		new SearchParallelPlane1(null, word_ParallelPlane1);		
	}
	...
	public void testConstructor_WordNULL() throws InvariantBroken {
		new SearchParallelPlane1(threeD, null);
	}
	...
	public void testConstructor_NOK() throws InvariantBroken {
		new SearchParallelPlane1(null, null);
	}
	...
	public AbstractSearch3D getContructor_SearchNotOK() throws InvariantBroken {
		...
		return new SearchParallelPlane1(threeD, word_search_overlen);
	}
